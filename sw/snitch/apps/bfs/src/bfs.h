...
void bfs_job(void *args) {
    ...
    if (snrt_is_compute_core()) {
        snrt_mcycle();
        frontier_job(num_vertices_frac, local_graph_offsets, local_graph_adjacencies, local_frontier, local_dist, local_new_frontier, local_new_dist);
        snrt_mcycle();
    };
